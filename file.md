# vall-e-x-_fork
Personal fork of Plachtaa's VALL-E X  zero-shot TTS model. This repository retains the original MIT License and credits all authors.
> ⚠️ This is a personal fork of Plachtaa's VALL-E X. All rights belong to the original authors. This repo is for personal/educational use only.
...
This repository is *not claimed as my own work*.  
All rights and ownership belong to the original authors.  

This project is licensed under the *Plachtaa License*. See the [LICENSE](./LICENSE) file for details.
